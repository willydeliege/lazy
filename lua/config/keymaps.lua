...
-- taskwarrior
vim.keymap.set("n", "<leader>tw", function() require("util").float_term({ "taskwarrior-tui" }) end, { desc = "Taskwarrior-tui" })
-- lazygit
...
vim.keymap.set("n", "<leader>oT", function() require("util").float_term() end, { desc = "Terminal (cwd)" })
...
vim.keymap.set("n", "<leader><tab>p", "<cmd>tabprevious<CR>", { desc = "Previous" })
